...
export function getSecurityOption () {
 ...
 */
export function getChinaMapOption(data, type) {
  let key = 'parentarea'
  ...
  function _getMax(data, key, type) {
    return data.map(item => { return item[type] }).sort(function (a, b) { return b - a })[0]
  }
